  ...
  render() {
    ...
    return (
      <div className="movie-card">
        ...
        <CardFront backgroundImage={posterMap[this.props.content.poster]}/>
        <CardBack title={this.props.content.title}
        rating={this.props.content.IMDBRating}
...
MovieCard.defaultProps = {content: {
  title: "Unknown",
  rating: null,
